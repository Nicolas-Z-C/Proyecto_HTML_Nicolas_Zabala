...
- **html/Catalog**: Ahora contiene las páginas individuales de los relojes (1.html a 20.html), ajustadas según las rutas en index.html (e.g., "/html/Catalog/1.html").
...
3. Navega por las secciones: Casa (index), Catálogo, Nosotros y Contacto.
4. Para ver páginas de relojes individuales, haz clic en los enlaces del catálogo que apuntan a `html/Catalog/[1-20].html`.
